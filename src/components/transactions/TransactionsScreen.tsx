    ...
    <div className="space-y-4">
      ...
      {tab === "Bon" ? (
        <EmptyState
          iconName="receipt"
          title="Belum ada bon"
          description="Transaksi bon (bayar nanti) akan tercatat di sini setelah kasir aktif di Tahap 3."
        >
        ...
        <EmptyState
          ...
          description="Transaksi tercatat otomatis setiap kali Anda berjualan dengan scan barcode (mulai Tahap 3)."
        >
          <LinkButton href="/scan" className="mt-2">
            Mulai Jualan
          </LinkButton>
      ...
      <p className="text-center text-[11px] text-stone-400">
        Riwayat lengkap &amp; pencarian transaksi hadir di Tahap 3 dan Tahap 5
      </p>
    </div>
  );
}
