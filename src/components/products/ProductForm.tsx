...
function toUnit(value: string | undefined): ProductUnit {
 ...
 * sederhana. Semua field — termasuk Satuan — bisa diedit; mengubah harga
 * TIDAK mengubah product_id maupun barcode produk.
 */
