    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-3">
      ...
      <div className="space-y-3 rounded-2xl bg-white p-4 ring-1 ring-stone-900/5">
        ...
        {mode === "create" ? (
          ...
          <div>
            <FieldLabel text="Satuan" hint="tidak bisa diubah" />
            <p className="flex min-h-12 items-center rounded-xl border border-dashed border-stone-200 bg-stone-50 px-3 text-sm text-stone-600">
              {product?.unit ?? "pcs"}
            </p>
          </div>
        )}
