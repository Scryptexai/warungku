...
export class MemoryLocalStore implements LocalStore {
  ...
  private aiProviderConfig: import("@/services/ai/ai-provider").RemoteAiConfig | null = null;
  ...
  async getAiProviderConfig(): Promise<import("@/services/ai/ai-provider").RemoteAiConfig | null> {
    return this.aiProviderConfig ? { ...this.aiProviderConfig } : null;
  }

  async setAiProviderConfig(
    config: import("@/services/ai/ai-provider").RemoteAiConfig | null,
  ): Promise<void> {
    this.aiProviderConfig = config ? { ...config } : null;
  }
